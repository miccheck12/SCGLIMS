...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collaborator.first_name'
        db.alter_column(u'lims_collaborator', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Collaborator.last_name'
        db.alter_column(u'lims_collaborator', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Collaborator.phone'
        db.alter_column(u'lims_collaborator', 'phone', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Collaborator.email'
        db.alter_column(u'lims_collaborator', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'Collaborator.first_name'
        db.alter_column(u'lims_collaborator', 'first_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Collaborator.last_name'
        db.alter_column(u'lims_collaborator', 'last_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Collaborator.phone'
        db.alter_column(u'lims_collaborator', 'phone', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Collaborator.email'
        db.alter_column(u'lims_collaborator', 'email', self.gf('django.db.models.fields.TextField')())
